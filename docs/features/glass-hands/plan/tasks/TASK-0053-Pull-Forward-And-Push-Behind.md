...
**Amended 2026-09-10 (ISS-0059).** A pull into a full front band vanished into the overflow count while the front plane said it had been pulled. A pulled note now takes one of the band's eight spare slots, and a pull even the spares cannot take is counted and said so. A push on a neighbour is refused in words, like a push on an owed note.
