...
- ~~The fourth band's name.~~ **Answered 2026-09-12: the outer field, `'outer'`.**
- **What the outer field's capacity should be.** It falls out of the derived shape rather than being written down, but the shape function needs a stated intent at both ends: how many cards an outer field may hold before it starts counting, and how small its cards may get. Task 2 chooses and writes the numbers in its Outcome.
