...
issues: ["[[ISS-0001-Cards-From-The-Previous-View-Stay-On-Screen]]", "[[ISS-0002-A-Second-Deck-Cannot-Start-And-Says-Nothing]]"]
depends: []
related: ["[[ISS-0001-Cards-From-The-Previous-View-Stay-On-Screen]]", "[[ISS-0002-A-Second-Deck-Cannot-Start-And-Says-Nothing]]", "[[ADR-0001-Deck-Serves-Its-Own-Read-Only-Host]]", "[[RISK-0001-A-Second-Sidecar-Takes-Over-Focus-Routing]]", "[[REFERENCE-SURFACE-ARCHITECTURE-OPTIONS]]", "[[REFERENCE-COCKPIT-ADOPTION]]", "[[DES-0002-The-Glass-Cockpit]]", "[[PHASE-0002-Glass]]", "[[PHASE-0003-Vault]]"]
...
- [ ] A popped-out window moved to a second display reopens on that display after Deck is restarted. **Amended 2026-09-06:** this said "a status window", and Deck has no status panel; what it has is a popped-out window, which is the same view in a second window with no navigation of its own. Edwin's walk stopped on the fiction, which is the criterion's fault rather than the walk's. **2026-09-06:** built, and the decision is a pure function tested over display sets including an unplugged monitor ([[TST-0003-A-Window-Is-Placed-On-The-Display-It-Was-On]]). The walk needs a second monitor and is [[TST-0009-A-Status-Window-Survives-A-Restart-On-A-Second-Display]].
