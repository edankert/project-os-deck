...
**Depends on [[PHASE-0001-Deck]], not on [[PHASE-0002-Glass]].** The seam this phase needs is the sidecar answering which views a workspace has, built in the Deck phase. Nothing here requires the field. The stated order still puts Vault third, which is Edwin's decision on 2026-09-06, not a technical constraint; grooming can bring it forward if a vault becomes the more valuable demonstration.
